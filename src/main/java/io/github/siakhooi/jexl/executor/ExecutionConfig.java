...
/**
 * Resolved execution: context, scripts, templates, and optional exit expression (from positional CLI or execution config YAML).
 *
 ...
 *                     config is built). When non-null, its numeric evaluation becomes the process exit code.
 */
public record ExecutionConfig(File contextFile, List<File> scriptFiles, String resultPathTemplate, File jarListFile,
        String exitCodeExpr) {
}
